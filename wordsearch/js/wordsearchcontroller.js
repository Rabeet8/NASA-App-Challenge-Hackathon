...
function WordSearchController(
  ...
  var searchTypes = {
    "J.W.S.T": [
      ["Stabilization Flap", "ISIM", "Spacecraft Bus", "Collecting Area"],
      ["Infrared Astronomy", "Trim Flapes", "Solar Panel", "Craft"],
      ["Bus", "Antenna", "MultiLayer Sheild", "Asteroids"],
      ["Integrated", "Science Instrument", "OTE Mirror", "NIRSpec"],
      ["NIRCam", "Gravitational Lens", "Sunshield", "Startrackers"],
    ],
